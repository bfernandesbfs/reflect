...
@interface NSNumber (SWIFT_EXTENSION(CoreReflect))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull declaredDatatype;)
+ (NSString * _Nonnull)declaredDatatype;
+ (NSNumber * _Nonnull)fromDatatypeValue:(NSNumber * _Nonnull)datatypeValue;
@end


@interface NSString (SWIFT_EXTENSION(CoreReflect))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull declaredDatatype;)
+ (NSString * _Nonnull)declaredDatatype;
...
/**
  Reflect Object
*/
SWIFT_CLASS("_TtC11CoreReflect7Reflect")
...
@interface Reflect (SWIFT_EXTENSION(CoreReflect))
