...
@interface NSData (SWIFT_EXTENSION(ReflectFramework))
+ (NSString * _Nonnull)declaredDatatype;
+ (NSData * _Nonnull)fromDatatypeValue:(NSData * _Nonnull)datatypeValue;
@end


@interface NSDate (SWIFT_EXTENSION(ReflectFramework))
+ (NSString * _Nonnull)declaredDatatype;
+ (NSDate * _Nonnull)fromDatatypeValue:(NSString * _Nonnull)datatypeValue;
...
@interface NSString (SWIFT_EXTENSION(ReflectFramework))
+ (NSString * _Nonnull)declaredDatatype;
+ (NSString * _Nonnull)fromDatatypeValue:(NSString * _Nonnull)datatypeValue;
@end
